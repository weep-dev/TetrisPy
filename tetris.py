...
anim_cout, anim_speed, anim_limit = 0, 60, 2000


bg = pygame.image.load('img/fundo2.png').convert()
...
while True:
    ...
    #move y
    anim_cout += anim_speed
    if anim_cout > anim_limit:
        anim_cout = 0
        figure_old = deepcopy(figure)
        for i in range(4):
            figure[i].y += 1
    ...
    #desenha a proxima figura
    for i in range(4):
        figure_rect.x = next_figure[i].x * TILE + 380
        figure_rect.y = next_figure[i].y * TILE + 185
        pygame.draw.rect(sc, 'white', figure_rect)

    # desenha os titulos
    sc.blit(title_tetris, (485, 15))
